...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ApolloLibraryAccessors extends SubDependencyFactory {
        ...
        private final ApolloTestingLibraryAccessors laccForApolloTestingLibraryAccessors = new ApolloTestingLibraryAccessors(owner);

        public ApolloLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>mockserver</b> with <b>com.apollographql.apollo3:apollo-mockserver</b> coordinates and
         * with version reference <b>apollo</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getMockserver() {
            return create("apollo.mockserver");
        }

        /**
         * Dependency provider for <b>runtime</b> with <b>com.apollographql.apollo3:apollo-runtime</b> coordinates and
         * with version reference <b>apollo</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Group of libraries at <b>apollo.normalized</b>
         */
        ...
        /**
         * Group of libraries at <b>apollo.testing</b>
         */
        public ApolloTestingLibraryAccessors getTesting() {
            return laccForApolloTestingLibraryAccessors;
        }
    ...
    public static class ApolloNormalizedLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>apollo.normalized.cache</b>
         */
    ...
    public static class ApolloNormalizedCacheLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>cache</b> with <b>com.apollographql.apollo3:apollo-normalized-cache</b> coordinates and
         * with version reference <b>apollo</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Dependency provider for <b>sqlite</b> with <b>com.apollographql.apollo3:apollo-normalized-cache-sqlite</b> coordinates and
         * with version reference <b>apollo</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class ApolloTestingLibraryAccessors extends SubDependencyFactory {

        public ApolloTestingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>support</b> with <b>com.apollographql.apollo3:apollo-testing-support</b> coordinates and
         * with version reference <b>apollo</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSupport() {
            return create("apollo.testing.support");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>apollo</b> with value <b>4.0.0-beta.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>kotlinApollo</b> with plugin id <b>com.apollographql.apollo3</b> and
         * with version <b>4.0.0-beta.6</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKotlinApollo() { return createPlugin("kotlinApollo"); }
